...
var Tag = function Tag(_ref) {
  ...
  return filter ? _react.default.createElement("div", _extends({
  ...
  }, children !== null && children !== undefined ? children : TYPES[type]), _react.default.createElement("button", {
    className: "".concat(prefix, "--tag__close-icon"),
    onClick: handleClose,
    "aria-labelledby": tagId
  }, _react.default.createElement(_iconsReact.Close16, null))) : _react.default.createElement("span", _extends({
    className: tagClasses
