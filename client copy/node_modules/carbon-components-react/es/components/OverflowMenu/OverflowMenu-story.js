...
storiesOf('OverflowMenu', module).addDecorator(withKnobs).add('basic', withReadme(OverflowREADME, function () {
  return React.createElement(OverflowMenu, props.menu(), React.createElement(OverflowMenuItem, _extends({}, props.menuItem(), {
    itemText: "Option 1",
    primaryFocus: true
  })), React.createElement(OverflowMenuItem, _extends({}, props.menuItem(), {
  ...
  return React.createElement(OverflowMenu, props.menu(), React.createElement(OverflowMenuItem, _extends({}, _objectSpread({}, props.menuItem(), {
    href: 'https://www.ibm.com'
  }), {
    itemText: "Option 1",
    primaryFocus: true
  })), React.createElement(OverflowMenuItem, _extends({}, _objectSpread({}, props.menuItem(), {
    href: 'https://www.ibm.com'
  }), {
    itemText: "Option 2 is an example of a really long string and how we recommend handling this",
    requireTitle: true
  ...
  return React.createElement(OverflowMenu, _objectSpread({}, props.menu(), {
    ariaLabel: null,
    style: {
      width: 'auto'
    },
