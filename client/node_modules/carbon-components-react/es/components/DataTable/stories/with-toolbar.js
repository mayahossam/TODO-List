...
export default (function (props) {
  return React.createElement(DataTable, _extends({
    ...
    render: function render(_ref) {
      ...
      }, getTableContainerProps()), React.createElement(TableToolbar, _extends({}, getToolbarProps(), {
        "aria-label": "data table toolbar"
      }), React.createElement(TableToolbarContent, null, React.createElement(TableToolbarSearch, {
