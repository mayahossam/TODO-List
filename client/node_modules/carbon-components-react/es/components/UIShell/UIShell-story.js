...
var StoryContent = function StoryContent(_ref) {
  ...
  }, "The shell is perhaps the most crucial piece of any UI built with", React.createElement("a", {
...
storiesOf('UI Shell', module).add('Header Base', withReadme(readme, function () {
  ...
  return React.createElement(React.Fragment, null, React.createElement(Header, {
    "aria-label": "IBM Platform Name"
  }, React.createElement(SkipToContent, null), React.createElement(HeaderName, {
    href: "#",
    prefix: "IBM"
  }, "[Platform]"), React.createElement(HeaderGlobalBar, null, React.createElement(HeaderGlobalAction, {
    "aria-label": "Search",
    ...
    "aria-label": "App Switcher",
    onClick: action('app-switcher click')
  }, React.createElement(AppSwitcher20, null)))), React.createElement(StoryContent, null));
  ...
  return React.createElement(React.Fragment, null, React.createElement(SideNav, {
    ...
    href: "javascript:void(0)"
  }, "L0 link"))), React.createElement(StoryContent, {
  ...
  return React.createElement(React.Fragment, null, React.createElement(SideNav, {
    ...
    renderIcon: Fade16,
    href: "javascript:void(0)"
  }, "Link"))), React.createElement(StoryContent, {
    useResponsiveOffset: false
  }));
