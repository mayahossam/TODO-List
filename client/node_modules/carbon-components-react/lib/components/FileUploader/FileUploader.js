...
function (_Component2) {
  ...
  _createClass(FileUploader, [{
    ...
    value: function render() {
      ...
      var selectedFileClasses = (0, _classnames.default)("".concat(prefix, "--file__selected-file"), (_classNames3 = {}, _defineProperty(_classNames3, "".concat(prefix, "--file__selected-file--field"), size === 'field'), _defineProperty(_classNames3, "".concat(prefix, "--file__selected-file--sm"), size === 'small'), _classNames3));
