...
(0, _react2.storiesOf)('OverflowMenu', module).addDecorator(_addonKnobs.withKnobs).add('basic', (0, _storybookReadme.withReadme)(_README.default, function () {
  return _react.default.createElement(_OverflowMenu.default, props.menu(), _react.default.createElement(_OverflowMenuItem.default, _extends({}, props.menuItem(), {
    itemText: "Option 1",
    primaryFocus: true
  })), _react.default.createElement(_OverflowMenuItem.default, _extends({}, props.menuItem(), {
  ...
  return _react.default.createElement(_OverflowMenu.default, props.menu(), _react.default.createElement(_OverflowMenuItem.default, _extends({}, _objectSpread({}, props.menuItem(), {
    href: 'https://www.ibm.com'
  }), {
    itemText: "Option 1",
    primaryFocus: true
  })), _react.default.createElement(_OverflowMenuItem.default, _extends({}, _objectSpread({}, props.menuItem(), {
    href: 'https://www.ibm.com'
  }), {
    itemText: "Option 2 is an example of a really long string and how we recommend handling this",
    requireTitle: true
  ...
  return _react.default.createElement(_OverflowMenu.default, _objectSpread({}, props.menu(), {
    ariaLabel: null,
    style: {
      width: 'auto'
    },
