...
function (_React$Component) {
  ...
  _createClass(Dropdown, [{
    ...
    value: function render() {
      ...
      var title = titleText ? _react.default.createElement("span", {
      ...
      return _react.default.createElement("div", {
        ...
        return _react.default.createElement(_ListBox.default, _extends({
        ...
        }, buttonProps), _react.default.createElement("span", _extends({
          id: fieldLabelId,
        ...
        })), _react.default.createElement(_ListBox.default.Menu, {
          "aria-labelledby": id,
          id: id
          ...
          }, itemProps), itemToElement ? _react.default.createElement(ItemToElement, _extends({
            key: itemProps.id
          }, item)) : itemToString(item), selectedItem === item && _react.default.createElement(_iconsReact.Checkmark16, {
