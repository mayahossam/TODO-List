...
var TabContentRenderedOnlyWhenSelected = function TabContentRenderedOnlyWhenSelected(_ref2) {
  ...
  return !selected ? React.createElement("div", _extends({}, other, {
...
storiesOf('Tabs', module).addDecorator(withKnobs).add('Default', function () {
  return React.createElement(Tabs, props.tabs(), React.createElement(Tab, _extends({
    id: "tab-1"
  }, props.tab(), {
    label: "Tab label 1"
  }), React.createElement("div", {
    className: "some-content"
  }, React.createElement("p", null, "Content for first tab goes here."))), React.createElement(Tab, _extends({
    id: "tab-2"
  }, props.tab(), {
    label: "Tab label 2"
  }), React.createElement("div", {
    className: "some-content"
  }, React.createElement("p", null, "Content for second tab goes here."))), React.createElement(Tab, _extends({
    id: "tab-3"
  }, props.tab(), {
    label: "Tab label 3",
    disabled: true
    ...
    className: "some-content"
  }, React.createElement("p", null, "Content for third tab goes here."))), React.createElement(Tab, _extends({
    id: "tab-4"
  }, props.tab(), {
    label: "Tab label 4",
    ...
    className: "some-content"
  }, React.createElement("p", null, "Content for fourth tab goes here."), React.createElement("p", null, "This example uses the\xA0", React.createElement(CodeSnippet, {
    type: "inline"
  }, "renderContent"), " prop to re-render content when the tab is selected."), React.createElement(CodeSnippetExample, null))), React.createElement(Tab, _extends({
    id: "tab-5"
  }, props.tab(), {
    ...
    className: "some-content"
  }, React.createElement("p", null, "Content for fifth tab goes here."))));
}, {
  info: {
  ...
  return React.createElement(Tabs, _extends({
    type: "container"
  }, props.tabs()), React.createElement(Tab, _extends({
    id: "tab-1"
  }, props.tab(), {
    label: "Tab label 1"
  }), React.createElement("div", {
    ...
    className: "some-content"
  }, React.createElement("p", null, "Content for third tab goes here."), React.createElement("p", null, "This example uses the\xA0", React.createElement(CodeSnippet, {
    type: "inline"
  }, "renderContent"), " prop to re-render content when the tab is selected."), React.createElement(CodeSnippetExample, null))), React.createElement(Tab, _extends({
    id: "tab-4"
  }, props.tab(), {
    ...
    className: "some-content"
  }, React.createElement("p", null, "Content for fourth tab goes here."), React.createElement(TextInput, {
    light: true,
    id: "sample-input",
