...
var CodeSnippetExample = function CodeSnippetExample() {
  return _react.default.createElement(_CodeSnippet.default, {
    type: "multi"
...
(0, _react2.storiesOf)('Tabs', module).addDecorator(_addonKnobs.withKnobs).add('Default', function () {
  return _react.default.createElement(_Tabs.default, props.tabs(), _react.default.createElement(_Tab.default, _extends({
  ...
  }, _react.default.createElement("p", null, "Content for first tab goes here."))), _react.default.createElement(_Tab.default, _extends({
    id: "tab-2"
  }, props.tab(), {
    label: "Tab label 2"
  }), _react.default.createElement("div", {
    className: "some-content"
  }, _react.default.createElement("p", null, "Content for second tab goes here."))), _react.default.createElement(_Tab.default, _extends({
    id: "tab-3"
  }, props.tab(), {
    label: "Tab label 3",
    disabled: true
    ...
    className: "some-content"
  }, _react.default.createElement("p", null, "Content for third tab goes here."))), _react.default.createElement(_Tab.default, _extends({
    id: "tab-4"
  }, props.tab(), {
    label: "Tab label 4",
    ...
    className: "some-content"
  }, _react.default.createElement("p", null, "Content for fourth tab goes here."), _react.default.createElement("p", null, "This example uses the\xA0", _react.default.createElement(_CodeSnippet.default, {
    type: "inline"
  }, "renderContent"), " prop to re-render content when the tab is selected."), _react.default.createElement(CodeSnippetExample, null))), _react.default.createElement(_Tab.default, _extends({
    id: "tab-5"
  }, props.tab(), {
    ...
    className: "some-content"
  }, _react.default.createElement("p", null, "Content for fifth tab goes here."))));
}, {
  info: {
  ...
  return _react.default.createElement(_Tabs.default, _extends({
    ...
    className: "some-content"
  }, _react.default.createElement("p", null, "Content for third tab goes here."), _react.default.createElement("p", null, "This example uses the\xA0", _react.default.createElement(_CodeSnippet.default, {
    type: "inline"
  }, "renderContent"), " prop to re-render content when the tab is selected."), _react.default.createElement(CodeSnippetExample, null))), _react.default.createElement(_Tab.default, _extends({
    id: "tab-4"
  }, props.tab(), {
    ...
    className: "some-content"
  }, _react.default.createElement("p", null, "Content for fourth tab goes here."), _react.default.createElement(_TextInput.default, {
    light: true,
    id: "sample-input",
