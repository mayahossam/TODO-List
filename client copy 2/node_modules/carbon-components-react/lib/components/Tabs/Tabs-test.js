  ...
  describe('renders as expected', function () {
    describe('navigation (<div>)', function () {
      ...
      it('supports container variant', function () {
        expect((0, _enzyme.shallow)(_react.default.createElement(_Tabs.default, {
          className: "extra-class",
          type: "container"
        }, _react.default.createElement(_Tab.default, {
          label: "firstTab"
  ...
  describe('events', function () {
    ...
    describe('keydown', function () {
      ...
      describe('state: selected', function () {
        beforeEach(function () {
          wrapper = (0, _enzyme.mount)(_react.default.createElement(_Tabs.default, {
            selected: 0
          }, _react.default.createElement(_Tab.default, {
            label: "firstTab",
            className: "firstTab"
      ...
      describe('ignore disabled child tab', function () {
        beforeEach(function () {
          wrapper = (0, _enzyme.mount)(_react.default.createElement(_Tabs.default, null, _react.default.createElement(_Tab.default, {
            label: "firstTab",
            className: "firstTab"
          }, "content1"), _react.default.createElement(_Tab.default, {
            label: "middleTab",
            className: "middleTab",
            disabled: true
          }, "content2"), _react.default.createElement(_Tab.default, {
            label: "lastTab",
            className: "lastTab"
          }, "content3")));
          firstTab = wrapper.find('.firstTab').last();
